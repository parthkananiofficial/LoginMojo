<x-guest-layout>
    ...
    <div class="bg-gray-400 h-screen w-screen">
        <div class="flex flex-col items-center flex-1 h-full justify-center px-4 sm:px-0"
            ...
            <div class="flex rounded-lg shadow-2xl w-full sm:w-3/4 lg:w-1/2 bg-white sm:mx-0" style="height: 500px;">
            ...
            background-size: cover; background-position: center center;">
                ...
                <div class="flex flex-col w-full md:w-1/2 p-4">
                    <div class="flex flex-col flex-1 justify-center mb-8">
                        ...
                        <section class="hero container max-w-screen-lg mx-auto pb-10 mb-4 border-b-2 border-gray-100">
                            {{-- <img class="mx-auto" src="https://picsum.photos/id/1/200/300" alt="screenshot" > --}}
                            <img class="mx-auto" src="{{ asset('img/loginwithwhatsapp-black.png') }}" width="300"
                                alt="Logo">
                        </section>

                        <div class="w-full mt-4">
                            <div class="form-horizontal w-2/4 mx-auto" method="POST" action="#">
